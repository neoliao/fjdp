...
PropertyCompany = Ext.extend(Ext.app.BaseFuncPanel,{
		...
		Ext.apply(this,{
			gridConfig:{
				cm:new Ext.grid.ColumnModel([
					...
					{header: '资质证书号',dataIndex:'certificateNumber',width :150},
					{header: '资质证书有效期',dataIndex:'certificateExpiryDate',width :150}
				]),	
				storeMapping:[
					'name','organizationCode','chargeMan','linkMan','telphone','address',
					'businessLicenceNumber','licenceExpiryDate','certificateNumber','certificateExpiryDate'
				],
			...
			formConfig:{
				items: [
					...
					{xtype: 'f-text',fieldLabel: '资质证书号',name: 'certificateNumber'},
					{xtype: 'f-text',fieldLabel: '资质证书有效期',name: 'certificateExpiryDate'},
					{xtype: 'f-textarea',fieldLabel: '地址',name: 'address'}

				]
			},
			url:ctx+'/propertyCompany'	
		});
		PropertyCompany.superclass.initComponent.call(this);
	}
